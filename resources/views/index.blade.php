      ...
      <div class="page-banner home-banner">
        <div class="row align-items-center flex-wrap-reverse h-100">
          <div class="col-md-6 py-5 wow fadeInLeft">
            <h1 class="mb-4">Sistem Klasifikasi Sampah</h1>
            <p class="text-lg text-grey mb-5">Sistem Klasifikasi Sampah Menggunakan Model Deep Learning Berbasis Web</p>
            <a href="https://www.youtube.com/watch?v=9OrkDz0VzPw" class="btn btn-primary btn-split" target="_blank">Watch Video <div class="fab"><span class="mai-play"></span></div></a>
          </div>
